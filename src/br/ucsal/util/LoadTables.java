...
public class LoadTables {
    ...
    public void creatScherma(Connection c) throws SQLException {
        ...
        stmt.execute("alter table materia_bibliografia add constraint fk_id_materia foreign key (id_materia) references materias(id);");

        stmt.execute("alter table materia_bibliografia add constraint fk_id_bibliografia foreign key (id_bibliografia) references bibliografia(id);");
